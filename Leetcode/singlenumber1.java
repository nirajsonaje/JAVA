...
//  we will perform the XOR operation of the element with 0, ans will become 0 if the same number is 
//  found (as a XOR a = 0) and so after the completion of the loop, only element with no duplicate number
